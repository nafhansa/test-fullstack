...
export default function UsersPage() {
  ...
  {/* HEADER: Pakai bg-blue-50 biar ada nuansa biru tipis */}
  <thead className="bg-blue-50/50">
    <tr>
      <th className="px-4 py-3 text-left text-sm font-bold text-gray-900 border-r border-b border-gray-200">
        #
      </th>
      <th className="px-4 py-3 text-left text-sm font-bold text-gray-900 border-r border-b border-gray-200">
        Nama Lengkap
    ...
    {loading ? (
      ...
      filteredUsers.map((user, index) => (
        <tr key={user.id} className="hover:bg-blue-50/30 transition-colors">
          ...
          {/* KOLOM AKSI (Tombol Kotak Outline) */}
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl my-8">
            <div className="flex items-center justify-between p-6 border-b bg-blue-600 border-gray-200 rounded-t-lg">
              ...
              <button 
                ...
                className="text-gray-300 hover:text-gray-300 text-3xl leading-none"
              >
                ✕
              </button>
            </div>
